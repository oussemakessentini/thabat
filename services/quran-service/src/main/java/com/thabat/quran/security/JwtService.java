package com.thabat.quran.security;
    ...
    public JwtService(JwtProperties jwtProperties) {
        ...
        if (secret == null || secret.isBlank()) {
            throw new IllegalStateException(
                    "JWT_SECRET is missing. Set it in services/quran-service/.env "
        ...
        if (keyBytes.length < 32) {
            throw new IllegalStateException(
                    "JWT_SECRET must be at least 32 characters for HS256. Current length: "
                            ...
                            + "services/quran-service/.env — remove it or set the full secret "
